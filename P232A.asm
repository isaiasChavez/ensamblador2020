...
.stack
.data
adir	db "..",00h	;Directorio superior y carácter nulo
bdir	db "dire",00h	;Directorio inferior y carácter nulo
...
main:	
    ...
    mov ah,3Bh   ;SE ACCEDE AL DIRECTORIO INFERIOR
	lea dx,bdir
	int 21h
	jc error
...
despc:	
	...
	mov si,[bp+4]
 dcl:	
    lodsb		;Carga en AL, incrementa SI
